...
public class Dir3 implements Serializable {
	...
	/**
	 * Gets the c dnm ud organica principalc id ud organica.
	 *
	 * @return the c dnm ud organica principalc id ud organica
	 */
	public String getCDnmUdOrganicaPrincipalcIdUdOrganica() {
		return this.cDnmUdOrganicaPrincipalcIdUdOrganica;
	}
