...
CREATE TABLE dir3 (
  C_ID_UD_ORGANICA varchar(255) NOT NULL,
  C_DNM_UD_ORGANICA varchar(255) DEFAULT NULL,
  C_ID_NIVEL_ADMON int(1) DEFAULT NULL,
  C_ID_DEP_UD_SUPERIOR varchar(255) DEFAULT NULL,
  C_DNM_UD_ORGANICA_SUPERIOR varchar(255) DEFAULT NULL,
  C_ID_DEP_UD_PRINCIPAL varchar(255) DEFAULT NULL,
  C_DNM_UD_ORGANICA_PRINCIPAL varchar(255) DEFAULT NULL,
  C_ID_AMB_PROVINCIA varchar(255) DEFAULT NULL,
  C_DESC_PROV varchar(255) DEFAULT NULL
);
